    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;">
      ...
      <tr>
        <td style="background-color:#ffffff;border:1px solid #daecc7;border-radius:20px;padding:48px 44px;">
          <table cellpadding="0" cellspacing="0" style="margin-bottom:28px;"><tr><td style="background-color:#f2f7ed;border:1px solid #c5e49a;border-radius:100px;padding:6px 14px;"><span style="font-family:Arial,Helvetica,sans-serif;font-size:11px;font-weight:700;letter-spacing:1px;color:#3a7a0a;text-transform:uppercase;">1-on-1 · Limited Spots</span></td></tr></table>
          <p style="margin:0 0 6px;font-family:Arial,Helvetica,sans-serif;font-size:22px;font-weight:700;color:#111111;line-height:1.3;">Hey ${firstName} — you caught my attention.</p>
          <p style="margin:0 0 28px;font-family:Arial,Helvetica,sans-serif;font-size:13px;font-weight:600;letter-spacing:0.5px;color:#3a7a0a;text-transform:uppercase;">I'd like to connect.</p>
          <p style="margin:0 0 18px;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:1.75;color:#444444;">Went through your application. What you wrote stood out.</p>
          <p style="margin:0 0 18px;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:1.75;color:#444444;">I keep my roster deliberately small — this is fully one-on-one coaching, not a group program or a template. Every person I work with gets my full attention, and I only bring someone on when I genuinely believe I can help them get there.</p>
          <p style="margin:0 0 36px;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:1.75;color:#444444;">Next step is a <strong style="color:#111111;">30-minute call</strong> — no pitch, no pressure. Just a real conversation to make sure this is the right fit for both of us before we commit to anything.</p>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;">
      ...
      <tr>
        <td style="background-color:#ffffff;border:1px solid #e5e5e3;border-radius:20px;padding:48px 44px;">
          ...
          <p style="margin:0 0 18px;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:1.75;color:#444444;">Thank you for taking the time — I genuinely read every application, and yours was no different.</p>
          <p style="margin:0 0 18px;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:1.75;color:#444444;">After sitting with it, I don't think the timing is right for us to work together. That's not a reflection of your goals or your drive — it's about fit, and fit matters a lot when coaching is this personal.</p>
          <p style="margin:0 0 18px;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:1.75;color:#444444;">I'll hold onto your info. Things change — programs evolve, spots open up — and if I ever feel like there's a real opening for you, I'll reach out personally.</p>
          <p style="margin:0 0 36px;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:1.75;color:#444444;">Wishing you real progress on this, wherever it comes from. The fact that you applied says a lot. Keep going. 💪</p>
